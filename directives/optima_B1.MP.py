...
class Directive(AbstractInstructionSet):
    ...
    def print_header(self):
        header = "OPTIMA: Artefact Deposit Events with 5 attributes"
        print(header)
        print('-' * len(header))
    ...
    def load_dataset(self, abox, tbox):
        ...
        pattern = (None,
                   rdflib.RDF.type,
                   rdflib.URIRef("http://purl.org/crmeh#EHE1004_ContextFindDepositionEvent"))

        # define context
        # spoor with vulling
        context = [rdflib.URIRef("http://purl.org/dc/elements/1.1/source"),
                   [rdflib.URIRef("http://www.cidoc-crm.org/cidoc-crm/P25F_moved"),
                    rdflib.URIRef("http://www.cidoc-crm.org/cidoc-crm/P2F_has_type"),
                    rdflib.RDF.value],
                   [rdflib.URIRef("http://www.cidoc-crm.org/cidoc-crm/P25F_moved"),
                    rdflib.URIRef("http://www.cidoc-crm.org/cidoc-crm/P45F_consists_of"),
                    rdflib.RDF.value],
                   [rdflib.URIRef("http://www.cidoc-crm.org/cidoc-crm/P26F_moved_to"),
                    rdflib.URIRef("http://www.cidoc-crm.org/cidoc-crm/P2F_has_type"),
                    rdflib.RDF.value],
                   [rdflib.URIRef("http://www.cidoc-crm.org/cidoc-crm/P26F_moved_to"),
                    rdflib.URIRef("http://www.cidoc-crm.org/cidoc-crm/P45F_consists_of"),
